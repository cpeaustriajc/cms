...
import { create as createField, edit as editField, index as indexFields, show as showField } from '@/routes/fields';
					...
					<div className="flex items-center gap-3">
						<div className="flex items-center gap-2">
							...
							<Select
								...
								onValueChange={(value) => onFilter('content_type', value)}
							>
						...
						/>
						<Button asChild>
							<Link href={createField().url}>Create</Link>
						</Button>
					</div>
				</div>
					...
					<Card>
						<CardContent className="flex items-center justify-center py-12">
							<div className="text-center">
								...
								<Button asChild>
									<Link href={createField().url}>Create your first field</Link>
								</Button>
							</div>
						</CardContent>
					</Card>
